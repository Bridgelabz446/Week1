...
//		size--;
	 ...
	 * item the item which to insert
	 *  IndexOutOfBoundsException if index is greater than size of list or is
	 *                                   less than 0
	 */
	 ...
	 * 
	 *  the last element of list after removing
	 */
	public T pop() {
		Node n = head;
		if (size == 1) {
